      ...
      <FadeInOnScroll>
        ...
        <div className="about-us-content"> {/* Updated class name */}
          <div className="about-us-text"> {/* Updated class name */}
            <p>
              Welcome to The Serene Touch, where tranquility meets convenience. We are dedicated to bringing
            ...
            <p>
              ...
              curate each session to ensure a serene and luxurious escape from the everyday hustle.
            ...
            <p>
              ...
              Let us transform your space into a sanctuary of peace and relaxation.
            </p>
          </div>
        </div>
      </FadeInOnScroll>
